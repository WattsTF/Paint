...
pygame.display.set_caption("Maravilloso Paint de Maravilloso Joska para Maravilloso Poo")
...
def fondo(colorf): 
    if colorf == "blanco":
        ...
        background_color = (102, 0, 161)
    elif colorf == "rosa":
        background_color = (255, 0, 255)
    elif colorf == "amarillo":
        ...
        if evento.type == pygame.QUIT:
            ...
            if evento.key == pygame.K_RETURN:
                ...
                if comando[0] == "exit":
                    ...
                    if len(comando) == 2:
                        try:
                            colorf = comando[1]  # Evalúa el nombre del color para obtener su valor
                            background_color = fondo(colorf)
                            ventana_principal.fill(background_color)
                        except:
                    ...
                    if len(comando) == 2:
                        ...
                        print("Blanco, Negro, rojo, azul, verde, morado, rosa, amarillo, naranja, gris, cafe")

                elif comando[0] == "help":
                    if len(comando) == 1:
                            archivo = open("help.txt","r")
